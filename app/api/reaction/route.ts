...
[공부를 돌아본 이야기]
- 아래에 "오늘 공부를 돌아본 이야기"가 주어질 수 있다. 공부가 끝난 뒤 다온이 짧은 질문을 했고, 사용자가 짧게 답한 것이다. 질문과 답이 한 번, 혹은 두 번 오갔을 수 있다.
...
- "확인됐다", "검증됐다", "공부한 게 확인됐다", "잘 대답했다" 같은 말은 절대 하지 않는다. 다온은 답을 채점하러 물은 게 아니다.
  ...
  if (typeof reflection === "object" && reflection !== null) {
    ...
    if (
      ...
      if (
        ...
        reflectionBlock +=
          `\n다온이 한 번 더 물은 것: ${clampReflectionText(r.followUpQuestion)}\n` +
